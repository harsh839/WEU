  ...
  return (
    ...
    <Header/>
      ...
      <div className="bg-black-900 flex flex-col items-center justify-start mx-auto md:pl-10 sm:pl-5 pl-[45px] py-[45px] w-[100vw] overflow-x-hidden">
        ...
        <div className="flex flex-col items-start  mb-[49px] mt-[21px] mx-auto w-[100vw] ">
          
          <div className="font-spacemono md:h-[1124px] h-[1317px] md:ml-[0] ml-[61px] relative w-[91%] md:w-full">
            <div className="absolute bottom-[0] h-[1124px] inset-x-[0] mx-auto w-[100%] md:w-full">
              ...
              <Text data-aos="fade-in"
                className="absolute flex inset-[0] items-center justify-center mb-auto ml-auto mx-auto md:text-5xl text-[160px] text-white-A700"
          ...
          <div data-aos="fade-in" className="bg-white-A700 hover:shadow-xl  cursor-pointer flex md:flex-col mt-20 flex-row font-spacemono gap-5 md:gap-[22px] items-center justify-center md:ml-[0] ml-[34%] p-2.5 w-[29%] md:w-full">
            <Text
              className="flex items-center justify-center cursor-pointer md:text-3xl sm:text-[28px] text-[32px] text-black-900"
              size="txtSpaceMonoBold32"
            >
              GO TO ORCHESTRA
            </Text>
            <Img
              className="h-[22px] mr-[7px] w-[22px]"
              src="images\img_upload.svg"
              alt="upload"
            />
          </div>
          <div data-aos='fade-up' className="w-[100%] mt-[20%] bg-black-900 text-gray-400 text-[50px] font-bold flex font-spacemono justify-center items-center ">
          ...
          <div className="flex flex-col font-spacemono items-center justify-center ml-[0] mt-[301px] md:w-full w-screen">
            <Button data-aos="fade-out"
              className="bg-transparent cursor-pointer flex flex-row items-center justify-center leading-[normal] mr-[7%] relative md:text-5xl text-[50px] text-center shadow-xl transition-all delay-50 ease-in-out hover:shadow-white-A700 text-white-A700 w-[90%]"
              size="md"
            >
            ...
            <Text data-aos="fade-in"
              className="mr-[7%] mt-[202px]  hover:shadow-2xl hover:shadow-white-A700 md:text-5xl text-[50px] text-center text-white-A700 w-[97%] sm:w-full"
